...
Этот репозиторий — только каталог (`.claude-plugin/marketplace.json`): он перечисляет три плагина и указывает, из каких репозиториев их брать. Файлы самих скиллов живут в своих репозиториях и подтягиваются автоматически, копий здесь нет. Когда скилл обновляется в своём репозитории, маркетплейс сразу отдаёт свежую версию.
