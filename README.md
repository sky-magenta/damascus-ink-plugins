...
Этот репозиторий — только каталог (`.claude-plugin/marketplace.json`): он перечисляет три плагина и указывает, из каких репозиториев их брать. Файлы самих скиллов живут в своих репозиториях и подтягиваются оттуда при установке, копий здесь нет. Каталог закрепляет проверенную версию каждого скилла; когда выходит обновление скилла, каталог обновляется вместе с ним.
